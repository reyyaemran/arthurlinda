  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-w-[min(320px,calc(100%-2rem))] translate-x-[-50%] translate-y-[-50%] gap-3 rounded-xl border border-border/60 p-5 shadow-xl duration-200 sm:max-w-sm",
          className
        )}
        {...props}
      />
...
function AlertDialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-row justify-center gap-2 pt-1",
        className
      )}
      {...props}
    />
