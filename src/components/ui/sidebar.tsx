...
function Sidebar({
  ...
  React.useEffect(() => {
    ...
    const didRouteChange = prevPathname !== pathname;
    if (isMobile && openMobile && didRouteChange) {
      setOpenMobile(false);
    }
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          className={cn(
            "text-sidebar-foreground w-(--sidebar-width) overflow-hidden border border-white/35 bg-white/10 p-0 backdrop-blur-xl backdrop-saturate-150 [&>button]:hidden",
            "!top-2 !bottom-2 !h-auto rounded-2xl",
